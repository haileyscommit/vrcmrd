...
export default function Dropdown({ items, class: className, label }: { items: { active: boolean, set: () => void, label: preact.VNode, description?: preact.VNode }[], class?: string, label?: preact.VNode }) {
